...
namespace SpartaTextRPG.Managers
{
    public class DataManager
    {
        ...
        {
            // 마법사
            SkillDict.Add(2101, new SkillData { DataId = 2101, SkillType = SkillType.Attack, Name = "매직 미사일", DamagePerValue = 1.2, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 1, DefaultMaxCastCount = 10, Description = "단발성 매직 미사일을 쏘고 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2102, new SkillData { DataId = 2102, SkillType = SkillType.Attack, Name = "파이어 볼", DamagePerValue = 2, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 3, DefaultMaxCastCount = 8, Description = "단발성 불속성 공격을 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2103, new SkillData { DataId = 2103, SkillType = SkillType.Heal, Name = "회복", DamagePerValue = 0, HealPerValue = 2, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 5, DefaultMaxCastCount = 5, Description = "상처를 공격력의 {HealPerValue}% 만큼 치유해 줍니다." });
            SkillDict.Add(2104, new SkillData { DataId = 2104, SkillType = SkillType.AOE, Name = "라이트닝", TargetCount = 3, DamagePerValue = 2.5, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 7, DefaultMaxCastCount = 3, Description = "번개를 쏘아 {TargetCount}명의 적에게 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2105, new SkillData { DataId = 2105, SkillType = SkillType.AOE, Name = "파이어 월", TargetCount = 6, DamagePerValue = 3, HealPerValue = 0, BuffPerValue = 0, ComboCount = 5, RequiredLevel = 10, DefaultMaxCastCount = 2, Description = "화염 벽을 깔고 {TargetCount}명의 적에게 연속으로 {ComboCount}회 공격하고 1회당 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });

            // 전사
            SkillDict.Add(2201, new SkillData { DataId = 2201, SkillType = SkillType.Attack, Name = "스매시", DamagePerValue = 1.5, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 1, DefaultMaxCastCount = 10, Description = "적을 강하게 때려 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2202, new SkillData { DataId = 2202, SkillType = SkillType.DefenseBuff, Name = "집결 함성", DamagePerValue = 0, HealPerValue = 0, BuffPerValue = 1.5, ComboCount = 1, RequiredLevel = 3, DefaultMaxCastCount = 3, Description = "전투중에 기본 능력치의 {BuffPerValue}% 만큼 방어력과 생명력을 증가 시킵니다." });
            SkillDict.Add(2203, new SkillData { DataId = 2203, SkillType = SkillType.Attack, Name = "피어스", DamagePerValue = 2, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 5, DefaultMaxCastCount = 6, Description = "적을 찌르고 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2204, new SkillData { DataId = 2204, SkillType = SkillType.AttackBuff, Name = "전투 함성", DamagePerValue = 0, HealPerValue = 0, BuffPerValue = 1.5, ComboCount = 0, RequiredLevel = 7, DefaultMaxCastCount = 3, Description = "전투중에 기본 능력치의 {BuffPerValue}% 만큼 공격력과 속도를 증가 시킵니다." });
            SkillDict.Add(2205, new SkillData { DataId = 2205, SkillType = SkillType.AOE, Name = "휠윈드", TargetCount = 6, DamagePerValue = 2.5, HealPerValue = 0, BuffPerValue = 0, ComboCount = 3, RequiredLevel = 10, DefaultMaxCastCount = 4, Description = "주변의 적 {TargetCount}명에게 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });

            // 궁수
            SkillDict.Add(2301, new SkillData { DataId = 2301, SkillType = SkillType.AOE, Name = "멀티샷", TargetCount = 3, DamagePerValue = 1.2, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 1, DefaultMaxCastCount = 8, Description = "여러개의 화살을 쏴서 {TargetCount}명에게 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2302, new SkillData { DataId = 2302, SkillType = SkillType.Attack, Name = "플레임 화살", DamagePerValue = 2, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 3, DefaultMaxCastCount = 6, Description = "화염 화살을 쏘고 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2303, new SkillData { DataId = 2303, SkillType = SkillType.Attack, Name = "포이즌 화살", DamagePerValue = 1.5, HealPerValue = 0, BuffPerValue = 0, ComboCount = 3, RequiredLevel = 5, DefaultMaxCastCount = 6, Description = "독 화살을 쏘고 공격력의 {DamagePerValue}% 만큼 {ComboCount}회 피해를 줍니다." });
            SkillDict.Add(2304, new SkillData { DataId = 2304, SkillType = SkillType.AttackBuff, Name = "명중률 향상", DamagePerValue = 0, HealPerValue = 0, BuffPerValue = 2, ComboCount = 1, RequiredLevel = 7, DefaultMaxCastCount = 3, Description = "일시적으로 명중률을 높여 치명적인 공격을 할 수 있게 합니다. {BuffPerValue}% 만큼 공격력과 속도를 향상시킵니다." });
            SkillDict.Add(2305, new SkillData { DataId = 2305, SkillType = SkillType.Attack, Name = "헤드샷", DamagePerValue = 5, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 10, DefaultMaxCastCount = 3, Description = "적의 머리를 조준하여 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });

            // 도적
            SkillDict.Add(2401, new SkillData { DataId = 2401, SkillType = SkillType.Attack, Name = "더블 어택", DamagePerValue = 1, HealPerValue = 0, BuffPerValue = 0, ComboCount = 2, RequiredLevel = 1, DefaultMaxCastCount = 5, Description = "일반 공격을 {ComboCount}회 가합니다. 회당 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2402, new SkillData { DataId = 2402, SkillType = SkillType.Attack, Name = "가속화", DamagePerValue = 0, HealPerValue = 0, BuffPerValue = 1.3, ComboCount = 1, RequiredLevel = 3, DefaultMaxCastCount = 3, Description = "가속화를 사용하여 {BuffPerValue}% 만큼 공격력과 속도를 높입니다." });
            SkillDict.Add(2403, new SkillData { DataId = 2403, SkillType = SkillType.Attack, Name = "트리플 어택", DamagePerValue = 1.2, HealPerValue = 0, BuffPerValue = 0, ComboCount = 3, RequiredLevel = 5, DefaultMaxCastCount = 5, Description = "일반 공격을 {ComboCount}회 가합니다. 회당 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2404, new SkillData { DataId = 2404, SkillType = SkillType.Attack, Name = "투척", DamagePerValue = 2.5, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 7, DefaultMaxCastCount = 3, Description = "투척 무기를 던져 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
            SkillDict.Add(2405, new SkillData { DataId = 2405, SkillType = SkillType.Attack, Name = "약점 공격", DamagePerValue = 3, HealPerValue = 0, BuffPerValue = 0, ComboCount = 2, RequiredLevel = 10, DefaultMaxCastCount = 3, Description = "적의 약점을 {ComboCount}회 공격하여 1회당 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
        }
        // 3101~4000
        private void LoadMonsters()
        {
            ...
            MonsterDict.Add(3201, new MonsterData { DataId = 3201, JobType = JobType.Archer, MonsterType = MonsterType.Common, Name = "스켈레톤", Description = "뼈만 남은 스켈레톤", Attack = 15, MaxHp = 300, Defense = 0, Speed = 10, Exp = 60, Gold = 1000, SkillIds = [], ItemIds = new int[] { 201 }, ItemDropRate = 0.5f });
            MonsterDict.Add(3202, new MonsterData { DataId = 3202, JobType = JobType.Archer, MonsterType = MonsterType.Common, Name = "좀비", Description = "부활한 좀비", Attack = 15, MaxHp = 500, Defense = 5, Speed = 5, Exp = 80, Gold = 2000, SkillIds = [], ItemIds = new int[] { 202 }, ItemDropRate = 0.5f });

            MonsterDict.Add(3301, new MonsterData { DataId = 3203, JobType = JobType.Mage, MonsterType = MonsterType.Elite, Name = "아네린", Description = "유명한 집사", Attack = 80, MaxHp = 550, Defense = 10, Speed = 30, Exp = 120, Gold = 3000, SkillIds = [2104], ItemIds = new int[] { 203 }, ItemDropRate = 0.5f });
            MonsterDict.Add(3302, new MonsterData { DataId = 3301, JobType = JobType.Archer, MonsterType = MonsterType.Elite, Name = "채리니", Description = "베일에 싸인 그분", Attack = 92, MaxHp = 470, Defense = 30, Speed = 10, Exp = 130, Gold = 1000, SkillIds = [2302], ItemIds = new int[] { 301 }, ItemDropRate = 0.5f });

            MonsterDict.Add(3401, new MonsterData { DataId = 3401, JobType = JobType.Thief, MonsterType = MonsterType.Elite, Name = "로끼", Description = "재빠른 원숭이", Attack = 87, MaxHp = 600, Defense = 15, Speed = 50, Exp = 140, Gold = 2000, SkillIds = [2401], ItemIds = new int[] { 401 }, ItemDropRate = 0.5f });
            MonsterDict.Add(3402, new MonsterData { DataId = 3402, JobType = JobType.Warrior, MonsterType = MonsterType.Elite, Name = "퇴실요정", Description = "드물게 나타나는 퇴실요정", Attack = 90, MaxHp = 700, Defense = 20, Speed = 55, Exp = 150, Gold = 3000, SkillIds = [2203], ItemIds = new int[] { 402 }, ItemDropRate = 0.5f });
