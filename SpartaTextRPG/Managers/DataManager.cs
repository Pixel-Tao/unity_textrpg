...
namespace SpartaTextRPG.Managers
{
    public class DataManager
    {
        ...
        private void LoadSkills()
        {
            ...
            SkillDict.Add(2104, new SkillData { DataId = 2104, SkillType = SkillType.AOE, Name = "라이트닝", TargetCount = 3, DamagePerValue = 2.5, HealPerValue = 0, BuffPerValue = 0, ComboCount = 1, RequiredLevel = 7, DefaultMaxCastCount = 2, Description = "번개를 쏘아 {TargetCount}명의 적에게 공격력의 {DamagePerValue}% 만큼 피해를 줍니다." });
        ...
        private void LoadMonsters()
        {
            ...
            MonsterDict.Add(3301, new MonsterData { DataId = 3203, JobType = JobType.Mage, MonsterType = MonsterType.Elite, Name = "안혜린 매니저님", Description = "유명한 집사", Attack = 50, MaxHp = 300, Defense = 10, Speed = 30, Exp = 120, Gold = 3000, SkillIds = [2104], ItemIds = new int[] { 203 }, ItemDropRate = 0.5f });
            MonsterDict.Add(3302, new MonsterData { DataId = 3301, JobType = JobType.Archer, MonsterType = MonsterType.Elite, Name = "강채린 매니저님", Description = "친절한 매니저님", Attack = 60, MaxHp = 350, Defense = 30, Speed = 10, Exp = 130, Gold = 1000, SkillIds = [2302], ItemIds = new int[] { 301 }, ItemDropRate = 0.5f });

            MonsterDict.Add(3401, new MonsterData { DataId = 3401, JobType = JobType.Thief, MonsterType = MonsterType.Elite, Name = "김록기 매니저님", Description = "재빠른 원숭이", Attack = 30, MaxHp = 600, Defense = 15, Speed = 50, Exp = 140, Gold = 2000, SkillIds = [2401], ItemIds = new int[] { 401 }, ItemDropRate = 0.5f });
            MonsterDict.Add(3402, new MonsterData { DataId = 3402, JobType = JobType.Warrior, MonsterType = MonsterType.Elite, Name = "퇴실 요정", Description = "드물게 나타나는 퇴실요정", Attack = 45, MaxHp = 700, Defense = 20, Speed = 55, Exp = 150, Gold = 3000, SkillIds = [2203], ItemIds = new int[] { 402 }, ItemDropRate = 0.5f });
